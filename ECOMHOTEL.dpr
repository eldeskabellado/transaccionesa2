...
uses
  ...
  UnitProveedor in 'UnitProveedor.pas' {FormBuscarProveedor},
  UnitEditarCompra in 'UnitEditarCompra.pas' {FormEditarCompra},
  UnitVerCompras in 'UnitVerCompras.pas' {FormVerCompras},
  UnitListaPrecios in 'UnitListaPrecios.pas' {FormLista},
  UnitReservas in '..\ecom-hotel\UnitReservas.pas',
  UnitChekin in '..\ecom-hotel\UnitChekin.pas',
  UnitCheckout in 'UnitCheckout.pas',
  UnitCrearReserva in '..\ecom-hotel\UnitCrearReserva.pas' {formCrearReserva};
